                ...
                <div class="container" style="border:0px solid black; margin-left:180px;">
                    ...
                    <div class="content_area">
                        ...
                        <table border="0" width="800" align="center">
                            ...
                            <tr>
                                <td align="right">
                                    <form name="frm" method="post" action="/libNoticeList.do?menu=1" class="search-form">
                        ...
                        <table border="0" width="1000" align="center">
                            <tr>
                                <td align="left"> Total : ${total } <button type="button" onclick="location='libNoticeWrite.do'" class="write1">작성</button> </td>
                            </tr>
                            ...
                            <c:forEach var="list" items="${resultList}" varStatus="status">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:left;">
                                        <a href="/libNoticeDetail.do?unq=${list.unq}">${list.title }</a>
                                    </td>
                                    <td>${list.name }</td>
                                    <td>
                    ...
                    <div class="page_number_area">
                        ...
                        <c:if test="${vo.pageIndex > 1}">
                            <a href="/libNoticeList.do?menu=1&amp;pageIndex=${vo.pageIndex - 1}&amp;searchCondition=${param.searchCondition}&amp;searchKeyword=${param.searchKeyword}">
                                이전
                            </a>
                        </c:if>
                        ...
                        <c:forEach var="pageNumber" begin="${startPage}" end="${endPage}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="/libNoticeList.do?menu=1&amp;pageIndex=${pageNumber}&amp;searchCondition=${param.searchCondition}&amp;searchKeyword=${param.searchKeyword}">
                                        ${pageNumber}
                                    </a>
                                </c:otherwise>
                            </c:choose>

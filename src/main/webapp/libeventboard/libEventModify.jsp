 ...
 $(function(){    
	 $("#button1").click(function(){ 
		 ...
		 if( $("#title").val() == "" ) {
		  ...
		  //var form = $("#frm").serialize(); //파일전송가능한 형태로 수정해야함
		  $.ajax({
			 // 전송관련 세팅
			 type : "POST",
			 data :  form,
			 url  : "/libEventModifySave.do",
        ...
        <div class="sec1">
            ...
            <div class="flex-item">
                <div class="container" style="border:0px solid black; margin-left:180px;">
                    ...
                    <div id="wrapper_title">문화행사 수정</div>
                        ...
                        <form name="frm" id="frm" enctype="multipart/form-data">
                            ...
                            <table class="board1" align="center">
                                ...
                                <tr>
								    <th>이미지</th>
								    <td>
								        <input type="file" name="file1" id="file1" style="width:50%" class="input1" value="${vo.file1 }" accept="image/*">
